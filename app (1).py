    ...
    def load_models_from_drive(self):
        ...
        try:
            ...
            with st.spinner("🔄 Downloading Improved U-Net from Google Drive..."):
                seg_url = f"https://drive.google.com/uc?id={https://drive.google.com/file/d/1oddiVJOirUYGhUnXHGqOrK8W1N7cUxIi/view?usp=drive_link}&export=download"
            ...
            with st.spinner("🔄 Downloading CNN Classifier from Google Drive..."):
                cls_url = f"https://drive.google.com/uc?id={https://drive.google.com/file/d/1EFYBAaMoLY6SCPO5fqyxPP870fnLbVtr/view?usp=drive_link}&export=download"
